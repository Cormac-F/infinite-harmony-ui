...
module.exports = function (app: Application) {
    ...
    app.post('/ask', async (req: Request, res: Response) => {
        try {
            ...
            let assistantId = "asst_xEHe7EABdb3PcsOWpwMLUsPa";
            const assistant = await openai.beta.assistants.retrieve(assistantId);
        
            console.log(
                "\nAssistant: Hello there! I'm here to help find information about a job!"
            );
            chatHistory.push("Assistant: Hello there! I'm here to help find information about a job!");
            ...
            while (keepAsking) {
                ...
                if (lastMessageForRun) {
                    lastMessageForRun.content.forEach((contentItem: any) => {
                ...
                if (!keepAsking) {
                console.log("Assistant: Thank you for using the Kainos Job Management System\n");
                chatHistory.push("Assistant: Thank you for using the Kainos Job Management System");
                }
            }
            res.render('index', { chatHistory });
